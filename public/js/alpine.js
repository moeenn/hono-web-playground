(() => {
  ...
  function Hn(e) {
    let [t, r] = _t(e), n = { interceptor: Ne, ...t };
    return re(e, r), n;
  }
  function or(e, t, r, ...n) {
    try {
...
`
  ...
  function xt(e, t) {
    let r = {};
    K(r, e);
    let n = [r, ...B(e)], i = typeof t == "function" ? Vn(n, t) : Un(n, t, e);
  ...
  function pr(e, t, r = {}) {
    let n = {};
    K(n, e);
    let i = [n, ...B(e)], o = k([r.scope ?? {}, ...i]), s = r.params ?? [];
    if (t.includes("await")) {
  ...
  function _e(e, t, r) {
    ...
    let n = {};
    return t.map(xr((o, s) => n[o] = s)).filter(br).map(Gn(n, r)).sort(Jn).map(
      (o) => Wn(e, o),
    );
  }
  function Et(e) {
  ...
  function vr() {
    ...
    Array.from(document.querySelectorAll(Or().join(","))).filter(e).forEach(
      (t) => {
        S(t);
      },
    ),
  ...
  function Wr(e, t) {
    ...
    Q[e] = t,
      ...
      typeof t.init == "function" && Q[e].init();
  }
  function Gr() {
    return Q;
  }
  ...
  var tn = Object.freeze({}), qs = Object.freeze([]);
  ...
  function Pi(e, t) {
    let r = Ee(e, t), n = e[t], i = Reflect.deleteProperty(e, t);
  ...
  function Xe(e, t) {
    return function (n, i) {
      let o = this, s = o.__v_raw, a = _(s), c = t ? Ft : e ? jt : Lt;
  ...
  y("id", (e, { cleanup: t }) => (r, n = null) => {
    let i = `${r}${n ? `-${n}` : ""}`;
    return Xi(e, i, t, () => {
      let o = wn(e, r), s = o ? o._x_ids[r] : zt(r);
      return n ? `${r}-${s}-${n}` : `${r}-${s}`;
    });
  });
  V((e, t) => {
  ...
  d("teleport", (e, { modifiers: t, expression: r }, { cleanup: n }) => {
    ...
    let i = Sn(r), o = e.content.cloneNode(!0).firstElementChild;
    e._x_teleport = o,
      o._x_teleportBack = e,
  ...
  d(
    ...
    (e, { modifiers: t, expression: r }, { effect: n, cleanup: i }) => {
      ...
      let u = e.tagName.toLowerCase() === "select" ||
  ...
  d("for", (e, { expression: t }, { effect: r, cleanup: n }) => {
    let i = lo(t), o = x(e, i.items), s = x(e, e._x_keyExpression || "index");
    e._x_prevKeys = [],
      e._x_lookup = {},
      r(() => co(e, i, o, s)),
      n(() => {
