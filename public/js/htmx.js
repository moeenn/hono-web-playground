var htmx = function () {
  ...
  function ze(h, d, p, g) {
    ...
    let e = function () {
      ...
      if (t.elt && !se(t.elt) && ee(t.elt, "id")) {
        ...
        const a = {
          preventScroll: p.focusScroll !== undefined
            ? !p.focusScroll
    ...
    if (
      t && ae(r, "htmx:beforeTransition", g.eventInfo) &&
  ...
  function ht(e, t) {
    if (e.type === "submit" && t.tagName === "FORM") return true;
    else if (e.type === "click") {
      const n = t.closest('input[type="submit"], button');
      if (n && n.form && n.type === "submit") return true;
      const r = t.closest("a");
      const o = /^#.+/;
      if (r && r.href && !o.test(r.getAttribute("href"))) return true;
    }
    return false;
  }
  function dt(e, t) {
    return oe(e).boosted && e instanceof HTMLAnchorElement &&
  ...
  function gt(l, c, e, u, f) {
    const a = oe(l);
    let t;
    if (u.from) t = m(l, u.from);
    else t = [l];
    if (u.changed) {
      if (!("lastValue" in a)) a.lastValue = new WeakMap();
      t.forEach(function (e) {
        if (!a.lastValue.has(u)) a.lastValue.set(u, new WeakMap());
    ...
    ie(t, function (i) {
      const s = function (e) {
        ...
        if (t.handledFor.indexOf(l) < 0) {
          ...
          if (u.target && e.target) { if (!h(ce(e.target), u.target)) return; }
          if (u.once) {
  ...
  function kt(t) {
    ...
    const r = wt(t, n, e);
    if (!r) {
      if (ne(t, "hx-boost") === "true") at(t, n, e);
  ...
  function ae(e, t, n) {
    ...
    n.elt = e;
    const r = Xt(t, n);
    if (Q.logger && !Ut(t)) Q.logger(e, t, n);
    if (n.error) {
      H(n.error);
  ...
  function $t(e) {
    jt = e;
    if (X()) sessionStorage.setItem("htmx-current-path-for-history", e);
  }
  ...
  function Gt() {
    const e = _t();
    let t = jt;
    if (X()) t = sessionStorage.getItem("htmx-current-path-for-history");
  ...
  function Qt(e) {
    ...
    t.onload = function () {
      ...
      } else fe(te().body, "htmx:historyCacheMissLoadError", r);
    };
    if (ae(te().body, "htmx:historyCacheMiss", r)) t.send();
  }
  function en(e) {
    Gt();
    ...
    } else {if (Q.config.refreshOnHistoryMiss) Q.location.reload(true);
      else Qt(e);}
  }
  function tn(e) {
  ...
  function un(e) {
    ...
    if (e instanceof HTMLInputElement && e.files) return M(e.files);
    return e.value;
  }
  function fn(t, n, r, e, o) {
    if (e == null || on(t, e)) return;
    else t.push(e);
    if (sn(e)) {
      const i = ee(e, "name");
      ln(i, un(e), n);
    ...
    if (e instanceof HTMLFormElement) {
      ie(e.elements, function (e) {
        if (t.indexOf(e) >= 0) cn(e.name, un(e), n);
        else t.push(e);
        if (o) an(e, r);
      });
  ...
  function mn(e, t, n) {
    ...
    if (oe(e).boosted) r["HX-Boosted"] = "true";
    return r;
  }
  function yn(n, e) {
    ...
    if (n) {
      ...
      if (s.length > 0) {
        for (let e = 0; e < s.length; e++) {
          ...
          else H("Unknown modifier in hx-swap: " + l);
        }
      }
    }
    return r;
  ...
  function wn(t, n, r) {
    ...
    if (o != null) return o;
    else {if (vn(n)) return hn(new FormData(), Dn(r));
      else return gn(r);}
  }
  function Sn(e) {
    return { tasks: [], elts: [e] };
  ...
  function En(e, t) {
    ...
    if (t.scroll) {
      var o = null;
      if (t.scrollTarget) o = ce(ue(n, t.scrollTarget));
      if (t.scroll === "top" && (n || o)) {
        o = o || n;
        o.scrollTop = 0;
      }
  ...
  function Cn(r, e, o, i, s) {
    ...
    if (l) {
      ...
      if (t) {
        n = On(r, function () {
          if (s) return Function("event", "return (" + e + ")").call(r, s);
          else return Function("return (" + e + ")").call(r);
        }, {});
      } else n = v(e);
      for (const c in n) {
        if (n.hasOwnProperty(c)) { if (i[c] == null) i[c] = n[c]; }
      }
    }
  ...
  function Ln(t, n, r) {
    ...
    if (r) {
      if (r instanceof Element || typeof r === "string") {
        ...
        let e = w(r.target);
        if (r.target && !e || r.source && !e && !w(r.source)) e = ve;
  ...
  function In(e, t, n) {
    ...
    const i = o === r.origin;
    if (Q.config.selfRequestsOnly) { if (!i) return false; }
  ...
  function he(t, n, r, o, i, k) {
    ...
    if (f) {
      ...
      if (L != null) {
        if (de.includes(L.toLowerCase())) t = L;
        else {
          re(s);
          return e;
        }
    ...
    if (d) {
      ...
      } else if (d === "replace") ae(h, "htmx:abort");
    ...
    if (u.xhr) {
      if (u.abortable) ae(h, "htmx:abort");
      else {
        if (p == null) {
          if (o) {
            const D = oe(o);
    ...
    if (i.headers) x = le(x, i.headers);
    const U = dn(r, t);
    let b = U.errors;
    const V = U.formData;
    if (i.values) hn(V, Dn(i.values));
    const j = Dn(Rn(r, o));
    const v = hn(V, j);
    let w = yn(v, r);
    ...
    g.onload = function () {
      try {
        ...
        M(r, T);
        if (T.keepIndicators !== true) rn(R, q);
  ...
  function Vn(t, e) {
    ...
    if (T(n, /HX-Trigger:/i)) Je(n, "HX-Trigger", t);
    ...
    let d = u.select;
    if (u.target) e.target = Un(t, u.target);
    var p = o.swapOverride;
    if (p == null && u.swapOverride) p = u.swapOverride;
    ...
    if (m.shouldSwap) {
      ...
      if (i) d = i;
      if (T(n, /HX-Reselect:/i)) d = n.getResponseHeader("HX-Reselect");
    ...
    if (a) {
      fe(
        ...
        "htmx:responseError",
        le({
          error: "Response Status Error Code " + n.status + " from " +
  ...
  function Gn(e) {
    if (Kn || te().readyState === "complete") e();
  ...
  function Wn() {
    if (Q.config.includeIndicatorStyles !== false) {
      ...
      te().head.insertAdjacentHTML(
        "beforeend",
        `<style${e}>` + `.${t}{opacity:0;visibility: hidden} ` +
